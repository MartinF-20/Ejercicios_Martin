...
public class GamePanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public GamePanel(int aiChoice) {
        ...
        setBackground(new Color(50, 150, 170));
    ...
    private void placeShip(Position targetPosition) {
        ...
        if(placingShipIndex < SelectionGrid.BOAT_SIZES.length) {
            ...
            statusPanel.setTopLine("¡Al ataque!");
            statusPanel.setBottomLine("Destruye todos los barcos enemigos para ganar");
        }
    }
    ...
    private void doPlayerTurn(Position targetPosition) {
        ...
        String hitMiss = hit ? "le dio" : "fallo";
        String destroyed = "";
    ...
    private void doAITurn() {
        ...
        statusPanel.setBottomLine("Bot " + hitMiss + " " + aiMove + destroyed);
